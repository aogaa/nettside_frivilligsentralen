(() => {
  ...
  footer.innerHTML = `
    <div class="contact-band-inner section">
      <a class="contact-band-facebook" href="https://www.facebook.com/stiftelsen.vestreakerfrivillighetssentral" target="_blank" rel="noopener noreferrer" aria-label="Følg oss på Facebook">
      ...
      <div class="contact-band-content">
        ...
        <p>Møteplass Vinderen<br>Slemdalsveien 72</p>
      </div>
    </div>
  `;
